...
import { Car, MapPin, Clock, DollarSign, User, LogOut, Menu, Star } from "lucide-react"
...
export function DriverLayout({ children }: DriverLayoutProps) {
  ...
  const navigation = [
    { name: "Dashboard", href: "/driver/dashboard", icon: Car },
    { name: "Active Rides", href: "/driver/rides", icon: MapPin },
            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="relative h-8 w-8 rounded-full">
                <Avatar className="h-8 w-8">
                  <AvatarFallback>{user.full_name?.charAt(0) || "D"}</AvatarFallback>
                </Avatar>
              </Button>
            </DropdownMenuTrigger>
