...
import { Car, DollarSign, Star, Clock, MapPin, Users, LogOut, TrendingUp } from "lucide-react"
...
export default function DriverDashboard() {
  ...
  const toggleOnlineStatus = () => {
    ...
    // Here you would typically update the driver's online status in the database
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-semibold">Muf Driver</h1>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-600">+0% from yesterday</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-sm font-medium text-gray-600">Rides Completed</CardTitle>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-600">Based on 0 rides</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                <CardTitle className="text-sm font-medium text-gray-600">Online Time</CardTitle>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          >
            ...
            <CardContent>
              <CardDescription>View and manage your current rides</CardDescription>
            </CardContent>
          </Card>
          ...
          >
            ...
            <CardContent>
              <CardDescription>View your completed rides</CardDescription>
            </CardContent>
          </Card>
        </div>
          ...
          <CardContent>
            {isOnline ? (
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-semibold text-green-600 mb-2">You're Online!</h3>
                <p className="text-gray-600 mb-4">Waiting for ride requests...</p>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 mb-4">Go online to start accepting ride requests</p>
